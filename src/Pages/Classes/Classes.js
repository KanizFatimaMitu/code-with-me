        ...
        <div className='mt-24'>
            <div class="flex flex-col w-full lg:flex-row">
                <div class="grid flex-grow h-32 card bg-base-300 rounded-box place-items-center">
                    ...
                    <label for="question-modal" class="btn modal-button font-bold text-info"> <FontAwesomeIcon icon={faPlusCircle}></FontAwesomeIcon>   Ask Question ?</label>
                ...
                <div class="grid flex-grow h-32 card bg-base-300 rounded-box place-items-center">
                    {/* <!-- The button to open modal --> */}
                    <label for="friend-modal" class="btn modal-button font-bold text-info"> <FontAwesomeIcon icon={faPlusCircle}></FontAwesomeIcon> Add friend ?</label>
